...
void createBoard(){
	...
	//It sets up the adjacent slots for the slots that are not at the borders. 
	//These slots have 4 adjacent elements
	...
	upLeft = &board[0][0];  //assigns a pointer to slot at position (0, 0)
	upRight = &board[0][boardSize -1];  //assigns pointer of pointer to slot at position (0, boardSize -1)
	downLeft = &board[boardSize -1][0];  //assigns pointer of pointer to slot at position ( boardSize -1,)
	downRight = &board[boardSize -1][boardSize -1];  //assigns pointer of pointer to slot at position (boardSize -1, boardSize -1)
	}
